function encryptRailFence(plaintext, rails) {
  let ciphertext = "";
  let railMatrix = Array.from(Array(rails), () =>
    new Array(plaintext.length).fill(0)
  );
  let row = 0;
  let col = 0;
  let down = false;
...
// let encrypted = encryptRailFence("HELLO world",4);
// console.log(encrypted);
// let decrypted = decryptRailFence(encrypted,4);
